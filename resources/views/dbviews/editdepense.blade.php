            ...
            <div class="ctn1">
                <div id="invoice">
                    ...
                    <div class="row">
                        ...
                        <form method="POST" action="/updatedepense/{{ $Depenseselect->id }}">
                            @csrf
                            @method('put')
                                    ...
                                    @foreach($Depenses as $Depense)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @method('DELETE')
                                                @csrf
                                                <button class="supprimerRevenu" formaction="{{ route('depense.delete', $Depense->id) }}">Supprimer</button>
                                            </td>
                                        </tr>
                                    @endforeach
                                </form>
